...
const Formulario = ({ id }) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://my-json-server.typicode.com/besta-mx/autosBesta/autos/${id}`
      )
      .then((response) => {
      ...
      <div className="c-wrapper-formulario">
        <div className="c-left-formulario">
          ...
          <div className="detalles-form">
            <img src={carrito} alt="" className="imgMini2" />{" "}
            <p className="texto-form">&nbsp; Estándar &nbsp;</p>
            <img src={calendar} alt="" className="imgMini" />{" "}
            <p className="texto-form"> &nbsp; 2022 &nbsp;</p>
            <img src={galardon} alt="" className="imgMini" />{" "}      
            <p className="texto-form"> &nbsp;Nuevo </p>
          </div>
          <div className="c-info-item-form">
            <StaticImage
              ...
              layout="fixed"
              atl="test"
              src={"https://bestaweb.netlify.app/assets/AVEO-OFI2.png"}
              width={533.328}
              height={400}
            />           
            <img src={tiempo} alt="" className="imgMini" />
            <p className="texto-meses">
              {" "}
            ...
            <br />
            <p className="montos">
              <strong> {carro.montoSemanal} /</strong>{" "}
            </p>
            ...
            <br />
            <p>
              * Consulta términos y condiciones * Precios sujetos a cambios sin
              previo aviso
            </p>
          </div>
        </div>
