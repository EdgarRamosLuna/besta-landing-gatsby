...
const Contact = () => {
  ...
  const data = useStaticQuery(graphql`
    query {
      introCarImg: file(relativePath: { eq: "solicitud-enviada.png" }) {
        childImageSharp {
          fluid(maxWidth: 1920) {
  ...
  `);
  //console.log(data.introCarImg.childrenImageSharp[0].fluid.base64);
  return (
      ...
      <div className="c-wrapper">
        <div className="c-left">
          <div className="c-info-item">
            ...
            />
            {/* <StaticImage
                      src="../../img/solicitud-enviada.png"
                      alt="Contacto besta" className="c-imagen"
                      width={1080}
                      height={1080}
                      quality={100}
                      loading="lazy"
